...
def lambda_handler(event, context):
    # Parameters
    source_bucket = "XXXXXXXX" # not public      # Source bucket name
    destination_bucket = "XXXXXXXX" # not public # Destination bucket name
    region_name = 'us-east-1'                  
    prefix = 'predictions/'                                # Specify prefix if copying specific folder
